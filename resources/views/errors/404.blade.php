                ...
                <div class="col-lg-12">
                    @if (Auth::check())
                        @if (Auth::user()->roles->pluck('name')[0] == 'Admin' ||
                            ...
                            <div class="text-center mb-5">
                                <h1 class="display-2 fw-medium">4<i
                                        class="bx bx-buoy bx-spin text-primary display-3"></i>4
                                </h1>
                        ...
                        @else
                            <div class="text-center mb-5">
                                <h1 class="display-2 fw-medium">4<i
                                        class="bx bx-buoy bx-spin text-warning display-3"></i>4
                                </h1>
                                <h4 class="text-uppercase">Sorry, page not found</h4>
                            </div>
                        @endif
                    @else
                        <div class="text-center mb-5">
                            <h1 class="display-2 fw-medium">4<i class="bx bx-buoy bx-spin text-warning display-3"></i>4
                            </h1>
                            <h4 class="text-uppercase">Sorry, page not found</h4>
                        </div>
                    @endif
