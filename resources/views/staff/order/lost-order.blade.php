...
@section('staff-title', 'Lost Order')
                    ...
                    <tbody>
                        ...
                        <form action="#" id="assingUserSubmit" method="POST">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge rounded-pill bg-success">{{ $order->courier->courier_name }}</span>
                                    {{-- <div class="btn-group">
                                        <button
                                ...
                                <td>
                                    <span class="badge rounded-pill bg-danger">{{ $order->status->os_name }}</span>
                                </td>
                                <td class="text-center">
                                    <div class="btn-group">
