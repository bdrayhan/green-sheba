...
@section('staff-title', 'Order Show')
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                @if (in_array($order->order_status, $orderStatus, true))
                    <a target="_blank" href="{{ route('admin.staff.order.invoice.print',$order->order_slug) }}" class="btn btn-info waves-effect waves-light">
                        <i class="bx bx-receipt font-size-16 align-middle"></i>
                    </a>
                @endif
                <a href="{{ route('admin.staff.order.edit', $order->order_slug) }}" class="btn btn-primary waves-effect waves-light">
                    <i class="bx bx-edit-alt font-size-16 align-middle"></i>
                </a>
                <a href="{{ route('admin.staff.status.order',$order->order_status) }}" class="btn btn-dark btn-soft waves-effect waves-light">
    ...
    <div class="col-md-3">
        <div class="card border border-secondary border-soft border-opacity-50">
            <div class="card-header d-flex justify-content-between">
                ...
                <span class="my-auto">{{ $order->complected_date ? $order->complected_date : 'No Complect' }}</span>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border border-secondary border-soft border-opacity-50">
            <div class="card-header d-flex justify-content-between">
                ...
                <span class="my-auto">{{ $order->invoice_date ? $order->invoice_date : 'No Invoice' }}</span>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border border-secondary border-soft border-opacity-50">
            <div class="card-header d-flex justify-content-between">
                ...
                <span class="my-auto">{{ $order->delivery_date ? $order->delivery_date : 'No Delivery' }}</span>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border border-secondary border-soft border-opacity-50">
            <div class="card-header d-flex justify-content-between">
                ...
                <span class="my-auto">{{ $order->collected_date ? $order->collected_date : 'No Collected' }}</span>
            </div>
        </div>
    </div>
</div>
                    ...
                    <table class="table table-responsive wrap table-bordered border-secondary border-soft border-opacity-50">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td >{{$detail->product_code ?? 'Not Avalable'}}</td>
