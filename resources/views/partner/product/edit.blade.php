        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div>
                    ...
                    <a href="{{ route('backend.partner.product') }}" class="btn btn-dark"><i class="bx bx-undo font-size-16"></i></a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('backend.partner.product.update', $product->product_slug) }}"
