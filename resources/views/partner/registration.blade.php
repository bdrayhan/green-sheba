...
@section('frontend-title', 'Partner Registration form')
@section('web.content')
    {{-- electrician start --}}
    <section class="container">
        <div class="row mt-5">
            <div class="col-12">
                <form method="post" action="{{route('partner.registration')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-header card_header">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <h4 class="card-title card_title"> Partner Registration form</h4>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
